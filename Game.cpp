...
SDL_AppResult Game::SDL_AppInit()
{
    ...
    TTF_Init();
    SDL_CreateWindowAndRenderer("SDL3 Game", 2560, 1440, SDL_WINDOW_RESIZABLE, &window, &renderer);
 ...
 // Создаем врагов
    ...
    enemies.push_back(new Enemy(renderer, 31700.0f, 2753.0f, EnemyType::Default));
